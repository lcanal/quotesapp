class Quote < ApplicationRecord
  ...
  after_create_commit lambda {
    cable_ready['hello_quotes'].insert_adjacent_html(
      ...
      position: 'afterBegin',
      html: ApplicationController.new.render_to_string(partial: 'welcome/quote', locals: { quote: self, prefix: nil })
    ).broadcast

    # REACTSECTION ActionCable.server.broadcast('hello_quotes', {
